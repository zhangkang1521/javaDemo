...
public class SnowflakeIdGenerator {
    ...
    /**
     * 开始使用该算法的时间为: 2015-01-01 00:00:00
     */
    private static final long START_TIME = 1735660800000L;
    ...
    /**
     * 最大的 worker id ，8191; 2^13-1
     */
    private final static long MAX_WORKER_ID = 8191L;
     ...
     * 最大的序列号，1023; 2^10-1
     */
    private final static long MAX_SEQUENCE = 1023L;
...
//            System.out.println("毫秒数相同序列号+1 " + sequence);

            if (sequence == MAX_SEQUENCE) {
                // 当前毫秒生成的序列数已经大于最大值，那么阻塞到下一个毫秒再获取新的时间戳
                current = this.nextMs(lastTimestamp);
//                System.out.println("lastTimestamp:" + lastTimestamp + " current:" + current);
            }
        } else {
            // 当前的时间戳已经是下一个毫秒
            sequence = 0L;
